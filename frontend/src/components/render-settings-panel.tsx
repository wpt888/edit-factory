    ...
    <Card variant="workspace" data-testid="step3-render-settings">
      ...
      <CardContent className="space-y-5">
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
          <div className="space-y-2">
            ...
            <Select value={presetName} onValueChange={onPresetNameChange}>
              <SelectTrigger id="render-export-preset" size="sm" className="text-xs">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="render-output-format" size="sm" className="text-xs" data-testid="render-output-format">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="render-encoding-mode" size="sm" className="text-xs">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="render-audio-quality" size="sm" className="text-xs">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
        ...
        <div className="grid max-w-md grid-cols-2 gap-3">
          <InspectorField label="Width" htmlFor="render-output-width">
            <Input
          ...
          <InspectorField label="Height" htmlFor="render-output-height">
            <Input
        ...
        <div className="divide-y divide-border/70 border-t border-border/70">
          <InspectorSwitchRow
            ...
            label="GPU Encoding"
            helper={is2Pass ? "Disabled for VBR 2-pass" : undefined}
          ...
          <InspectorSection
            ...
            summary={`Color correction ${adjustments.enableColor ? "on" : "off"}`}
          ...
          >
            <InspectorSwitchRow
              ...
              helper="Burn brightness, contrast, and saturation into the final video."
            ...
            {adjustments.enableColor && (
              <div className="space-y-2">
                {([
                  ...
                  <div key={key} className="grid min-h-6 grid-cols-[7rem_1fr_auto] items-center gap-2">
          ...
          <InspectorSection
            ...
            summary={`Volume ${Math.round(adjustments.voiceVolume * 100)}% · ${fadeSummary}`}
          ...
          >
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-muted-foreground">100% keeps the voiceover unchanged.</p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {([
                ...
                <InspectorField key={key} label={label} htmlFor={`render-${key}`}>
                  <Select
                    value={String(adjustments[key])}
                    onValueChange={(value) => updateAdjustments({ [key]: Number(value) })}
                  >
                    <SelectTrigger id={`render-${key}`} size="sm" className="text-xs">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
          ...
          >
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              <InspectorField label="H.264 Profile" htmlFor="render-video-profile">
                <Select
                ...
                >
                  <SelectTrigger id="render-video-profile" size="sm" className="text-xs">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <InspectorField label="H.264 Level" htmlFor="render-video-level">
                <Select value={settings.video_level} onValueChange={(value) => update({ video_level: value })}>
                  <SelectTrigger id="render-video-level" size="sm" className="text-xs">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <InspectorField label="Encoding Speed" htmlFor="render-encoding-speed">
                <Select value={settings.preset_speed} onValueChange={(value) => update({ preset_speed: value })}>
                  <SelectTrigger id="render-encoding-speed" size="sm" className="text-xs">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
            ...
            <div className="grid min-h-6 grid-cols-[7rem_1fr_auto] items-center gap-2">
              ...
              />
              <span className="w-10 text-right font-mono text-xs tabular-nums text-muted-foreground">{settings.gop_size}</span>
            </div>
          </InspectorSection>
        </div>
      </CardContent>
