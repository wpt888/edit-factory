...
6. **Inject subtitle enhancement settings into subtitle_settings dict** in `_render_final_clip_task()`, BETWEEN the SRT file creation block (lines 1832-1836) and the `_render_with_preset()` call (line 1841). Add BEFORE the _render_with_preset call:
   ```python
