...
<task type="checkpoint:human-verify" gate="blocking">
  <name>Task 3: Verify Assembly page visually</name>
  <files>frontend/src/app/assembly/page.tsx, frontend/src/components/navbar.tsx</files>
  <action>
Verify the assembly page renders correctly by visual inspection. Check:
...
6. Review the Playwright screenshot at frontend/screenshots/verify-assembly-page.png
  ...
  <verify>Visual inspection of /assembly page via Playwright screenshot and browser check</verify>
  <done>Assembly page looks correct with all elements rendering properly</done>
