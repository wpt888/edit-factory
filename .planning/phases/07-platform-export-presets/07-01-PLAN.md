...
must_haves:
  truths:
    - "User selecting TikTok preset gets CRF 20 video quality"
    - "User selecting Reels/YouTube preset gets CRF 18 video quality"
    - "Exported videos have 2-second keyframe intervals (gop=60 at 30fps)"
    - "Audio in exported videos is 192k bitrate"
    - "Unknown platform falls back to Generic preset gracefully"
  artifacts:
    - path: "app/services/encoding_presets.py"
      ...
      min_lines: 80
    - path: "tests/test_encoding_presets.py"
      provides: "Unit tests for encoding presets"
      min_lines: 50
  key_links:
