...
- [x] **ELEC-03**: Installer size is under 500 MB (optimized PyTorch/Whisper bundling strategy)
- [x] **ELEC-04**: Auto-updater downloads and installs updates from GitHub Releases
- [x] **ELEC-05**: App has a consistent icon, splash screen, and window title matching the product brand
